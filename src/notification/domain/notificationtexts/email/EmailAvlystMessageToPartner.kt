...
class EmailAvlystMessageToPartner {
    companion object {
        ...
        fun getPreviewMessage(henting: PlanlagtHenting): String {
            return "Din henting hos ${henting.stasjonNavn} stasjon " +
        ...
        fun getInputParams(henting: PlanlagtHenting, aarsak: Aarsak): SESInputParams {
            return SESInputParams(getSubject(), getPreviewMessage(henting), getMessage(henting, aarsak))
        }
    }
}
