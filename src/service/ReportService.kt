...
import ombruk.backend.database.ReportRepository
import ombruk.backend.database.Reports
...
object ReportService : IReportService {
    ...
    override fun getReportById(id: Int) = transaction {
        ReportRepository.getReportByID(id).leftIfNull { ServiceError("No report with ID $id exists") }
    }
