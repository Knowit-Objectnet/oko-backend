...
object KeycloakGroupIntegration {
     ...
     * receive the response. Also handles any errors that might occur.
     */
    private fun performRequestHelper(
        method: HttpMethod,
        url: String,
        contentType: ContentType? = null,
        body: String? = null
    ): Either<KeycloakIntegrationError, String> {
        ...
        return runCatching { runBlocking { client.request(requestBuilder) as String } }
            .fold({ it.right() }, {
    ...
    /**
     * Handles errors that occurs when a request is sent and received. Helper function for [performRequestHelper].
