...
interface IUttakService {
    ...
    /**
     * Gets a list of uttaks constrained by the values passed into the [uttakGetForm].
     * @param uttakGetForm The constraints to apply to the query. If all properties are null, all uttaks will be queried.
    ...
    /**
     * Deletes one or more uttaks specified by the values passed into the [uttakDeleteForm].
     * @param uttakDeleteForm The constraints to apply to the query. If all properties are null, all uttaks will be deleted.
    ...
    /**
     * Updates a singular uttak. Must be called several times to update all uttaks belonging to a recurrence rule.
